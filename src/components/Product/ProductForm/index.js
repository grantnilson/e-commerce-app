...
const ProductForm = () => {
  ...
  const handleImageChange = (e) => {
    ...
    //check if larger than 2 megabytes
  ...
  return (
    <form onSubmit={handleSubmitProduct} className="w-96 mx-auto space-y-2">
      <div className="w-full">
        ...
        <input
          ...
          name="name"
          id="name"
          className="outline-black border border-gray p-2 placeholder:text-gray-400 w-full"
...
const ProductForm = () => {
  ...
  const handleSubmitProduct = async (e) => {
    ...
    if (error) return toast.error(error.message, setLoading);
